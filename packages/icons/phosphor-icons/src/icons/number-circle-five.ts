...
/**
 * Phosphor `number-circle-five` icon.
 *
 * @tag c2-phosphor-number-circle-five
 *
 * @cssproperty {pixel} [--c2-phosphor-icon--size=24px]
 * @cssproperty {color} [--c2-phosphor-icon--color=currentColor]
 */
@customElement('c2-phosphor-number-circle-five')
export class PhosphorNumberCircleFiveIcon extends PhosphorIcon {
...
declare global {
  interface HTMLElementTagNameMap {
    'c2-phosphor-number-circle-five': PhosphorNumberCircleFiveIcon
  }
}
