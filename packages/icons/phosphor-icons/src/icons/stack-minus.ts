...
/**
 * Phosphor `stack-minus` icon.
 *
 * @tag c2-phosphor-stack-minus
 *
 * @cssproperty {pixel} [--c2-phosphor-icon--size=24px]
 * @cssproperty {color} [--c2-phosphor-icon--color=currentColor]
 */
@customElement('c2-phosphor-stack-minus')
export class PhosphorStackMinusIcon extends PhosphorIcon {
...
declare global {
  interface HTMLElementTagNameMap {
    'c2-phosphor-stack-minus': PhosphorStackMinusIcon
  }
}
