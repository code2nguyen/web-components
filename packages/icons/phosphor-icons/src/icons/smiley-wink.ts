...
/**
 * Phosphor `smiley-wink` icon.
 *
 * @tag c2-phosphor-smiley-wink
 *
 * @cssproperty {pixel} [--c2-phosphor-icon--size=24px]
 * @cssproperty {color} [--c2-phosphor-icon--color=currentColor]
 */
@customElement('c2-phosphor-smiley-wink')
export class PhosphorSmileyWinkIcon extends PhosphorIcon {
...
declare global {
  interface HTMLElementTagNameMap {
    'c2-phosphor-smiley-wink': PhosphorSmileyWinkIcon
  }
}
