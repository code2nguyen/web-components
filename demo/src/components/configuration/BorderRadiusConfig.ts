  ...
  render() {
    return html`<div class="border-radius-config">
      ...
      <div class="border-radius-wrapper">
        ...
        <!-- right -->
        <c2-text-field id="1" .value=${this.radiusValues[1]} @change=${this.handleRadiusChange}>
          <svg slot="prefix-icon" viewBox="0 0 8 8">
        ...
        <!-- bottom -->
        <c2-text-field id="2" .value=${this.radiusValues[2]} @change=${this.handleRadiusChange}>
          <svg slot="prefix-icon" viewBox="0 0 8 8">
        ...
        <!-- left -->
        <c2-text-field id="3" .value=${this.radiusValues[3]} @change=${this.handleRadiusChange}>
          <svg slot="prefix-icon" viewBox="0 0 8 8">
