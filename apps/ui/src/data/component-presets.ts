...
export const componentPresets: Record<string, ComponentPresetGroup> = {
  ...
  'c2-pagination': {
    html: `<c2-pagination total-pages="9" page="3" hide-nav-labels></c2-pagination>`,
    presets: [
      {
        name: 'Accent pills',
        description: 'Fully rounded numbers with the current page on the accent colour.',
        css: {
      ...
      {
        name: 'Outlined',
        description: 'Every control in its own hairline box, the current page inverted.',
        css: {
      ...
      {
        name: 'Quiet',
        description: 'Smaller, lighter numbers; the current page is marked by weight alone.',
        css: {
      ...
      {
        name: 'Table footer',
        description: 'The compact variant, pushed to the right the way a data table ends.',
        attributes: { variant: 'compact', 'total-items': '100', 'page-size': '10' },
        css: { '--c2-pagination--justify-content': 'flex-end', '--c2-pagination--section-gap': '28px' },
      },
      {
        name: 'Simple',
        description: 'Previous and next around a page status, for a narrow toolbar.',
        attributes: { variant: 'simple', 'total-pages': '12' },
      },
    ],
  },
  'c2-button-group': {
    ...
    presets: [
      {
        ...
        css: { '--c2-theme-select__trigger--border': '1px solid #bcbcc6', '--c2-theme-select__trigger--border-radius': '6px' },
      },
      {
        name: 'Pill',
  ...
  'c2-menu': {
    html: `<c2-menu aria-label="Actions"><c2-button slot="trigger">Open</c2-button><c2-menu-item value="new">New file</c2-menu-item><c2-menu-item value="duplicate">Duplicate</c2-menu-item><hr /><c2-menu-item value="delete" destructive>Delete</c2-menu-item></c2-menu>`,
    presets: [
      {
        name: 'Soft',
        description: 'Borderless surface, deeper shadow, rounded rows.',
        css: {
      ...
      {
        name: 'Compact',
        description: 'Dense rows for a context menu.',
        css: {
      ...
      {
        name: 'Dark',
        description: 'Near-black surface with a lighter destructive row.',
        css: {
      ...
      {
        name: 'Tinted rows',
        description: 'Indigo hover tint and a matching focus ring.',
        css: {
  ...
  'c2-navigation-menu': {
    html: `<c2-navigation-menu aria-label="Main"><c2-navigation-menu-item value="products">Products<div style="display:grid;gap:2px;width:210px" slot="panel"><c2-navigation-menu-link href="#a">Analytics<span slot="description">Realtime dashboards</span></c2-navigation-menu-link><c2-navigation-menu-link href="#b">Warehouse<span slot="description">Columnar storage</span></c2-navigation-menu-link></div></c2-navigation-menu-item><c2-navigation-menu-item value="docs" href="#docs">Docs</c2-navigation-menu-item><c2-navigation-menu-item value="pricing" href="#pricing" current>Pricing</c2-navigation-menu-item></c2-navigation-menu>`,
    presets: [
      {
        name: 'Underline',
        description: 'No hover fill; the indicator sits right under the label.',
        css: {
      ...
      {
        name: 'Pill bar',
        description: 'Tinted rail with fully rounded items and no indicator.',
        css: {
      ...
      {
        name: 'No indicator',
        description: 'No line at all; the open and current items are marked by a chip.',
        css: {
          '--c2-navigation-menu-item__indicator--height': '0px',
      ...
      {
        name: 'Dark header',
        description: 'Near-black bar and panel with a violet indicator.',
        css: {
      ...
      {
        name: 'Mobile',
        description: 'One button opening the whole navigation as a hierarchy list.',
        attributes: { mode: 'mobile' },
      },
      {
        name: 'Mobile, collapsible',
        description: 'The same list with one group open at a time, on a pill button.',
        attributes: { mode: 'mobile', collapsible: '' },
        css: {
      ...
      {
        name: 'Soft panel',
        description: 'Borderless panel with a deep shadow and rounded rows.',
        css: {
