...
/**
 * Phosphor `lighthouse` icon.
 *
 * @tag c2-phosphor-lighthouse
 *
 * @cssproperty {pixel} [--c2-phosphor-icon--size=24px]
 * @cssproperty {color} [--c2-phosphor-icon--color=currentColor]
 */
@customElement('c2-phosphor-lighthouse')
export class PhosphorLighthouseIcon extends PhosphorIcon {
...
declare global {
  interface HTMLElementTagNameMap {
    'c2-phosphor-lighthouse': PhosphorLighthouseIcon
  }
}
