...
//
// Vue template types for the custom elements of @c2n/link-button. Import once, anywhere in the program:
//
...
import type { LinkButton } from '@c2n/link-button'
...
declare module 'vue' {
  interface GlobalComponents {
    'c2-link-button': DefineComponent<
      C2Props<LinkButton> & {
        'aria-label'?: unknown
      }
    >
