...
//
// Vue template types for the custom elements of @c2n/dropdown-list. Import once, anywhere in the program:
//
//     import '@c2n/dropdown-list/vue'
//
...
declare module 'vue' {
  interface GlobalComponents {
    'c2-dropdown-list': DefineComponent<C2Props<DropdownList>>
  }
}
