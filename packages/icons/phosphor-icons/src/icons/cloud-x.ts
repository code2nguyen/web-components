...
/**
 * Phosphor `cloud-x` icon.
 *
 * @tag c2-phosphor-cloud-x
 *
 * @cssproperty {pixel} [--c2-phosphor-icon--size=24px]
 * @cssproperty {color} [--c2-phosphor-icon--color=currentColor]
 */
@customElement('c2-phosphor-cloud-x')
export class PhosphorCloudXIcon extends PhosphorIcon {
...
declare global {
  interface HTMLElementTagNameMap {
    'c2-phosphor-cloud-x': PhosphorCloudXIcon
  }
}
