...
/**
 * Phosphor `file-x` icon.
 *
 * @tag c2-phosphor-file-x
 *
 * @cssproperty {pixel} [--c2-phosphor-icon--size=24px]
 * @cssproperty {color} [--c2-phosphor-icon--color=currentColor]
 */
@customElement('c2-phosphor-file-x')
export class PhosphorFileXIcon extends PhosphorIcon {
...
declare global {
  interface HTMLElementTagNameMap {
    'c2-phosphor-file-x': PhosphorFileXIcon
  }
}
