 ...
 *
 * @cssproperty {pixel} [--c2-details__header__icon--width=24px]
 * @cssproperty {pixel} [--c2-details__header__icon--height=24px]
 * @cssproperty {pixel} [--c2-details__header__icon--rotage=180deg]
 * @cssproperty {color} --c2-details__header__icon--color
 *
 * @cssproperty {background} [--c2-details__header__hover--background=rgb(230, 230, 230)]
 *
 * @cssproperty {padding} [--c2-details__content--padding-top=8px]
