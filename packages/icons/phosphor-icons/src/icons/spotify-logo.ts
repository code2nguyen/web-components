...
/**
 * Phosphor `spotify-logo` icon.
 *
 * @tag c2-phosphor-spotify-logo
 *
 * @cssproperty {pixel} [--c2-phosphor-icon--size=24px]
 * @cssproperty {color} [--c2-phosphor-icon--color=currentColor]
 */
@customElement('c2-phosphor-spotify-logo')
export class PhosphorSpotifyLogoIcon extends PhosphorIcon {
...
declare global {
  interface HTMLElementTagNameMap {
    'c2-phosphor-spotify-logo': PhosphorSpotifyLogoIcon
  }
}
