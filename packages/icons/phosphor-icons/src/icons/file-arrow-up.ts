...
/**
 * Phosphor `file-arrow-up` icon.
 *
 * @tag c2-phosphor-file-arrow-up
 *
 * @cssproperty {pixel} [--c2-phosphor-icon--size=24px]
 * @cssproperty {color} [--c2-phosphor-icon--color=currentColor]
 */
@customElement('c2-phosphor-file-arrow-up')
export class PhosphorFileArrowUpIcon extends PhosphorIcon {
...
declare global {
  interface HTMLElementTagNameMap {
    'c2-phosphor-file-arrow-up': PhosphorFileArrowUpIcon
  }
}
