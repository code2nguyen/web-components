...
/**
 * Phosphor `handbag` icon.
 *
 * @tag c2-phosphor-handbag
 *
 * @cssproperty {pixel} [--c2-phosphor-icon--size=24px]
 * @cssproperty {color} [--c2-phosphor-icon--color=currentColor]
 */
@customElement('c2-phosphor-handbag')
export class PhosphorHandbagIcon extends PhosphorIcon {
...
declare global {
  interface HTMLElementTagNameMap {
    'c2-phosphor-handbag': PhosphorHandbagIcon
  }
}
