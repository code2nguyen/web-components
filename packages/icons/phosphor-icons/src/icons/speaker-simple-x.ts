...
/**
 * Phosphor `speaker-simple-x` icon.
 *
 * @tag c2-phosphor-speaker-simple-x
 *
 * @cssproperty {pixel} [--c2-phosphor-icon--size=24px]
 * @cssproperty {color} [--c2-phosphor-icon--color=currentColor]
 */
@customElement('c2-phosphor-speaker-simple-x')
export class PhosphorSpeakerSimpleXIcon extends PhosphorIcon {
...
declare global {
  interface HTMLElementTagNameMap {
    'c2-phosphor-speaker-simple-x': PhosphorSpeakerSimpleXIcon
  }
}
