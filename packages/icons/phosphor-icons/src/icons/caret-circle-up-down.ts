...
/**
 * Phosphor `caret-circle-up-down` icon.
 *
 * @tag c2-phosphor-caret-circle-up-down
 *
 * @cssproperty {pixel} [--c2-phosphor-icon--size=24px]
 * @cssproperty {color} [--c2-phosphor-icon--color=currentColor]
 */
@customElement('c2-phosphor-caret-circle-up-down')
export class PhosphorCaretCircleUpDownIcon extends PhosphorIcon {
...
declare global {
  interface HTMLElementTagNameMap {
    'c2-phosphor-caret-circle-up-down': PhosphorCaretCircleUpDownIcon
  }
}
