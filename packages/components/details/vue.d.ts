...
//
// Vue template types for the custom elements of @c2n/details. Import once, anywhere in the program:
//
...
import type { Details, DetailsEventMap } from '@c2n/details'
...
declare module 'vue' {
  interface GlobalComponents {
    'c2-details': DefineComponent<
      C2Props<Details> & {
        'title-not-clickable'?: unknown
        onToggle?: (event: DetailsEventMap['toggle']) => void
      }
    >
  }
}
