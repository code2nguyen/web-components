    ...
    return html`<div class="color-config">
        ...
        <div class="color-wrapper"> 
          <div class="color-input-group">         
            <c2-color-select class="color-select" placement="bottom-end" .hue=${this.h} .saturation=${this.h} .value=${this.h} .alpha=${this.a} @change=${this.handleColorSelectChange}> </c2-color-select>
            <c2-text-field class="color-input" .value=${this.tinyColor.toHexString()}></c2-text-field>
            <c2-text-field class="alpha-input" .value=${this.a * 100 + '%'}></c2-text-field>
          </div>
          <c2-checkbox class="show-option" .checked=${this.show} >
