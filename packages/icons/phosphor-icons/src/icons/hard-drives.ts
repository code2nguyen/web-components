...
export class PhosphorHardDrivesIcon extends PhosphorIcon {
  protected override renderIcon(weight: PhosphorIconWeight) {
    switch (weight) {
      ...
      case 'bold':
        return svg`<path d="M208,36H48A20,20,0,0,0,28,56V200a20,20,0,0,0,20,20H208a20,20,0,0,0,20-20V56A20,20,0,0,0,208,36Zm-4,24v56H52V60ZM52,196V140H204v56ZM160,88a16,16,0,1,1,16,16A16,16,0,0,1,160,88Zm32,80a16,16,0,1,1-16-16A16,16,0,0,1,192,168Z"/>`
      case 'fill':
...
declare global {
  interface HTMLElementTagNameMap {
    'c2-phosphor-hard-drives': PhosphorHardDrivesIcon
  }
}
