  ...
  private generateBorderIcon() {
    if (this.label.endsWith('top')) {
      return svg`<svg viewBox="0 0 24 24" slot="prefix-icon">
                ...
                ></path>
                <path fill="#e6e1e3" fill-opacity="1" fill-rule="evenodd" stroke="none" d="M6 6h12v1H6V6z"></path>
              </svg>`
    }
    if (this.label.endsWith('right')) {
      return svg`<svg viewBox="0 0 24 24" slot="prefix-icon">
            ...
            ></path>
            <path fill="#e6e1e3" fill-opacity="1" fill-rule="evenodd" stroke="none" d="M18 6v12h-1V6h1z"></path>
          </svg>`
    }
    if (this.label.endsWith('bottom')) {
      return svg`<svg viewBox="0 0 24 24" slot="prefix-icon">
            ...
            ></path>
            <path fill="#e6e1e3" fill-opacity="1" fill-rule="evenodd" stroke="none" d="M18 18H6v-1h12v1z"></path>
          </svg>`
    }
    ...
    return svg`<svg viewBox="0 0 24 24" slot="prefix-icon">
            ...
            ></path>
            <path fill="#e6e1e3" fill-opacity="1" fill-rule="evenodd" stroke="none" d="M6 18V6h1v12H6z"></path>
          </svg>`
  }
  render() {
