...
import type { BuiltinLanguage, SpecialLanguage, ThemeRegistration, ThemeRegistrationRaw } from 'shiki'
import { createShikiHighlighter, type ShikiConfig, type ShikiHighlighter, type ThemePresets } from './shiki'
