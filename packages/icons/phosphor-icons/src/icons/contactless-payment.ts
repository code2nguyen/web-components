...
/**
 * Phosphor `contactless-payment` icon.
 *
 * @tag c2-phosphor-contactless-payment
 *
 * @cssproperty {pixel} [--c2-phosphor-icon--size=24px]
 * @cssproperty {color} [--c2-phosphor-icon--color=currentColor]
 */
@customElement('c2-phosphor-contactless-payment')
export class PhosphorContactlessPaymentIcon extends PhosphorIcon {
...
declare global {
  interface HTMLElementTagNameMap {
    'c2-phosphor-contactless-payment': PhosphorContactlessPaymentIcon
  }
}
