    ...
    return html`<div class="padding-config">
      ...
      <c2-text-field id="0" .value=${this.paddingValues[0]} @input=${this.handlePaddingChange}>
        <svg slot="prefix-icon" viewBox="0 0 12 12" fill="none">
          <path fill-rule="evenodd" clip-rule="evenodd" d="M2 2L10 2L10 3L2 3L2 2Z" fill="#e6e1e3" />
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
      ...
      <c2-text-field id="1" .value=${this.paddingValues[1]} @input=${this.handlePaddingChange}>
        <svg slot="prefix-icon" viewBox="0 0 12 12" fill="none">
          <path fill-rule="evenodd" clip-rule="evenodd" d="M10 2L10 10L9 10L9 2L10 2Z" fill="#e6e1e3" />
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
      ...
      <c2-text-field id="2" .value=${this.paddingValues[2]} @input=${this.handlePaddingChange}>
        <svg slot="prefix-icon" viewBox="0 0 12 12" fill="none">
          <path fill-rule="evenodd" clip-rule="evenodd" d="M10 10L2 10L2 9L10 9L10 10Z" fill="#e6e1e3" />
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
      ...
      <c2-text-field id="3" .value=${this.paddingValues[3]} @input=${this.handlePaddingChange}>
        <svg slot="prefix-icon" viewBox="0 0 12 12" fill="none">
          <path fill-rule="evenodd" clip-rule="evenodd" d="M2 10V2H3V10H2Z" fill="#e6e1e3" />
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
