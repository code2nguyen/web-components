...
/**
 * Phosphor `smiley-sad` icon.
 *
 * @tag c2-phosphor-smiley-sad
 *
 * @cssproperty {pixel} [--c2-phosphor-icon--size=24px]
 * @cssproperty {color} [--c2-phosphor-icon--color=currentColor]
 */
@customElement('c2-phosphor-smiley-sad')
export class PhosphorSmileySadIcon extends PhosphorIcon {
...
declare global {
  interface HTMLElementTagNameMap {
    'c2-phosphor-smiley-sad': PhosphorSmileySadIcon
  }
}
