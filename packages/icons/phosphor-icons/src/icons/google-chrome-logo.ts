...
/**
 * Phosphor `google-chrome-logo` icon.
 *
 * @tag c2-phosphor-google-chrome-logo
 *
 * @cssproperty {pixel} [--c2-phosphor-icon--size=24px]
 * @cssproperty {color} [--c2-phosphor-icon--color=currentColor]
 */
@customElement('c2-phosphor-google-chrome-logo')
export class PhosphorGoogleChromeLogoIcon extends PhosphorIcon {
...
declare global {
  interface HTMLElementTagNameMap {
    'c2-phosphor-google-chrome-logo': PhosphorGoogleChromeLogoIcon
  }
}
